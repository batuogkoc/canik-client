...
//---------------------------------------------------------------------------------------------------
// Definitions
const sampleFreq = 512.0;
const betaDef = 0.1;
//---------------------------------------------------------------------------------------------------
// Variable definitions
var beta = betaDef;
var q0 = 1.9, q1 = 0.0, q2 = 0.0, q3 = 0.0;
...
void MadgwickAHRSupdate(double gx, double gy, double gz, double ax, double ay,
  ...
  if (!((ax == 0.0) && (ay == 0.0) && (az == 0.0))) {
    ...
    recipNorm = 1 /
        sqrt(s0 * s0 + s1 * s1 + s2 * s2 + s3 * s3); // normalise step magnitude
    s0 *= recipNorm;
    s1 *= recipNorm;
    s2 *= recipNorm;
    s3 *= recipNorm;
