      ...
      children: [
                      ...
                      children: [
                        Container(
                          ...
                          child: Card(
                            ...
                            child: Image.asset('assets/images/sfs/sfs-connect-gun.png'),
                          ),
                        ),
                      ],
                    ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Card(
                            ...
                            color: const Color(0xff232931),
                            child: Image.asset('assets/images/sfs/sfs-connect-mobile.png'),
                          ),
                        ),
                      ],
                    ),
                    StreamBuilder<bool>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return isError == false && isClicked == false
                              ? TextButton(
                                  onPressed: () {
                                    context.isAndroidDevice ? FlutterBluePlus.instance.turnOn() : null;
                                      ...
                                      builder: (context) {
                                        return WillPopScope(
                                          ...
                                          child: AlertDialog(
                                            ...
                                            titleTextStyle: _SfsConnectTextStyles.akhand16,
                                            title: SingleChildScrollView(
                                              child: Column(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text(AppLocalizations.of(context)!.sfs_connected_devices,
                                                  ...
                                                  Text(AppLocalizations.of(context)!.sfs_scanned_devices,
                                                      style: _SfsConnectTextStyles.akhand16),
                        ...
                        ? Column(
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: const Color(0xff102136), borderRadius: BorderRadius.circular(16)),
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Image.asset('assets/images/sfs/sfs-connect-info-circle.png'),
                                        ),
                                        SizedBox(
                                          width: 40.w,
                                          child: Text(
                              ...
                              Padding(
                                ...
                                child: Opacity(
                                    opacity: 0.6,
                                    child: Text(AppLocalizations.of(context)!.please_bluetooth,
                                        style: _SfsConnectTextStyles.akhand16)),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(top: 20.0),
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                        ...
                                        child: Text(
                                          AppLocalizations.of(context)!.continue_upper,
                                          style: _SfsConnectTextStyles.built17,
                                        )),
                                  ],
                                ),
        ...
        Positioned(
          ...
          child: SizedBox(
            ...
            child: Container(
              decoration: BoxDecoration(
                  border: Border.all(color: const Color(0xff5F6979)), // 0xffFF5063
                  borderRadius: const BorderRadius.all(Radius.circular(50)),
                  color: const Color(0xff232931)), // 0xffFF5063
              child: GestureDetector(
                onTap: () {
                   
                   Navigator.push(context, MaterialPageRoute(builder: (context) =>const SfsCalibrationTestPage()));
                },
                child: Image.asset('assets/images/sfs/sfs-connect-link.png')), //sfs-connect-danger.png
            ),
          ),
        ),
      ],
...
class _SfsConnectTextStyles {
  static const TextStyle built32 =
      TextStyle(fontSize: 32, fontFamily: 'Built', fontWeight: FontWeight.w500, color: Colors.white);
  static const TextStyle akhand16 = TextStyle(fontSize: 14, fontWeight: FontWeight.w300, color: Colors.white);
  static const TextStyle built17 = TextStyle(fontSize: 17, fontWeight: FontWeight.w500, color: Colors.white);
}
